...
const Invoices = () => {
  ...
  const columns = [
    ...
    columnHelper.accessor("itemsCount", {
      ...
      cell: (info) => {
        ...
        const addOns: AddOn[] = info.row.original.addOns
          ? JSON.parse(info.row.original.addOns)
          : undefined;
    ...
    columnHelper.display({
      ...
      cell: ({
        ...
        <Link
          href={`/operator/bills/download/invoices/${_id}`}
          className="flex items-center justify-center h-8 px-3 rounded-md text-xs font-medium transition-colors bg-green-50 text-green-700 hover:bg-green-100 border border-green-300 cursor-pointer"
        >
    ...
    columnHelper.display({
      ...
      cell: (info) => (
        <div className="flex space-x-2">
          <Link
            href={`/operator/bills/invoices/edit-invoice/${info.row.original._id}`}
  ...
  return (
    <Layout title="Invoices" active={1} subActive={1}>
          ...
          <div className="pb-6 px-6">
            <div className="flex flex-col-reverse sm:flex-row gap-4 justify-between items-start sm:items-center my-6">
              ...
              <Link
                ...
                href={"/operator/bills/invoices/add-invoice"}
              >
